...
<section class="lots">
  ...
  <ul class="lots__list">
    ...
    <li class="lots__item lot">
      ...
      <div class="lot__info"> <span class="lot__category">
        ...
        <div class="lot__state">
          <div class="lot__rate"> <span class="lot__amount">Стартовая цена</span> <span class="lot__cost">
            <?= strip_tags($val['price']); ?>
            <b class="rub">р</b></span> </div>
